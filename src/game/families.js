...
export const FAMILIES = [
  ...
  ...trackPair({
    ...
    badgeName: "Zero Hour",
    tier: 9,
    buildEntries: (switchMode) => fakieSpinEntries(SOUL_GRIND_NAMES, "None", switchMode),
  }),
  ...trackPair({
    id: "zerospin-groove",
    name: "Zerospin Groove",
    badgeName: "Zero Gravity",
    tier: 10,
    buildEntries: (switchMode) => fakieSpinEntries(GROOVE_GRIND_NAMES, "None", switchMode),
  }),
  ...trackPair({
    id: "zerospin-top",
